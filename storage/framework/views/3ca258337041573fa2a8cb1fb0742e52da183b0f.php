        ...
        <table class="table table-striped">
            ...
            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <td><?php echo e($row->updated_at); ?></td>                                    
                    <td><a href="<?php echo e(url('pelanggan/' . $row->pel_id . '/edit')); ?>" class="btn btn-secondary">Edit</a></td>
                    <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel-quis_pbwd_dwika1\resources\views/pelanggan/index.blade.php ENDPATH**/ ?>